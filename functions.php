...
if ( ! function_exists( 'jstream_setup' ) ) :
	...
	function jstream_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'jstream_custom_background_args', array(
...
function jstream_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'jstream_content_width', 640 );
}
 ...
 */
function jstream_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'jstream' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'jstream' ),
...
add_action( 'widgets_init', 'jstream_widgets_init' );
...
function jstream_scripts() {
	...
	wp_enqueue_script( 'jstream-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'jstream-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
